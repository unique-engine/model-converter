...
/**
 * Creates a matrix for an orthographic parallel viewing volume, using left-handedness, clip space "-1 to 1"
 * @param	{Real} left
 * @param	{Real} right
 * @param	{Real} bottom
 * @param	{Real} top
 ...
 */
function mat4_ortho_LH_MO(left, right, bottom, top, znear, zfar) {
