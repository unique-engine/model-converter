...
/**
 * Creates a matrix for a symmetric perspective-view frustum with far plane at infinite, right handedness
 ...
 */
function mat4_infinite_perspective_RH(fovy, aspect, near) {
