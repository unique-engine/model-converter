...
/**
 * Builds a perspective projection matrix based on a field of view, left handedness, clip space "0 to 1"
 ...
 */
function mat4_perspective_fov_LH_ZO(fov, width, height, near, far) {
