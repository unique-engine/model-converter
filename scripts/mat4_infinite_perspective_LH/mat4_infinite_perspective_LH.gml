...
/**
 * Creates a matrix for a symmetric perspective-view frustum with far plane at infinite, left handedness
 ...
 */
function mat4_infinite_perspective_LH(fovy, aspect, near) {
