...
/**
 * Returns a perspective projection matrix with the given parameters, right handedness, clip space "-1 to 1"
 ...
 */
function mat4_perspective_RH_MO(fovy, aspect, near, far) {
