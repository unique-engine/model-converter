...
/**
 * Returns a perspective projection matrix with the given parameters, left handedness, clip space "-1 to 1"
 ...
 */
function mat4_perspective_LH_MO(fovy, aspect, near, far) {
