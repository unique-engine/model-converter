...
/**
 * Creates a matrix for an orthographic parallel viewing volume, using right-handedness, clip space "0 to 1"
 * @param	{Real} left
 * @param	{Real} right
 * @param	{Real} bottom
 * @param	{Real} top
 ...
 */
function mat4_ortho_RH_ZO(left, right, bottom, top, znear, zfar) {
